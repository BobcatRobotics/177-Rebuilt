...
public class FlywheelTuningCommand extends Command {
    ...
    public FlywheelTuningCommand(FlywheelSubsystem flywheel, double maxVel) {
    ...
    public void execute() {
        ...
        flywheel.updateDashboard(state.toString(), setpoint, velocity);
    }
    ...
    private void log(double velocity, double error) {
        Logger.recordOutput("Flywheel/Tuning/State", state.toString());
        Logger.recordOutput("Flywheel/Tuning/Velocity", velocity);
        Logger.recordOutput("Flywheel/Tuning/Setpoint", setpoint);
        Logger.recordOutput("Flywheel/Tuning/Error", error);

        Logger.recordOutput("Flywheel/Tuning/kS", kS);
        Logger.recordOutput("Flywheel/Tuning/kP", kP);
        Logger.recordOutput("Flywheel/Tuning/kV", kV);
