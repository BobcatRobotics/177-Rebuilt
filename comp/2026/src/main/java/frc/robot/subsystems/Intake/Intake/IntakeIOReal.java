...
public class IntakeIOReal implements IntakeIO{
    ...
    //private final TalonFXConfigurator intake_config2;
    ...
    public IntakeIOReal(int RightID, int LeftID){
        ...
        //intake_config2 = intake_right.getConfigurator();
        intake_left.setControl(new Follower(Constants.IntakeConstants.RightRollerConstants.rollerMotorId, MotorAlignmentValue.Opposed));
