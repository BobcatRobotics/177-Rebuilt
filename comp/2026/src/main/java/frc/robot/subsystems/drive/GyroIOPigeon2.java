...
public class GyroIOPigeon2 implements GyroIO {
  ...
  public GyroIOPigeon2() {
    ...
    CANDeviceDetails tmp = new CANDeviceDetails(TunerConstants.DrivetrainConstants.Pigeon2Id,TunerConstants.kCANBus.getName(),Manufacturer.Ctre,"Drive",DeviceType.PIGEON2);    
    rioDevices.add(tmp);
