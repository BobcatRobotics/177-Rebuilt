...
public class climberCharacterizationCommands {
    ...
    private static Command characterize(
        ...
        return Commands.sequence(
                ...
                Commands.run(zeroVoltage::run, climber)
    ...
    public static Command feedforwardCharacterization_Climber(Climber climber) {
        return characterize(
                climber,
                () -> climber.runCharacterization_Climber(0.0),
                climber::runCharacterization_Climber,
                climber::getFFCharacterizationVelocity_Climber,
                "Climber/Characterization",
                "ClimberMotor");
    }

    public static Command characterizeAll(Climber climber) {
        return feedforwardCharacterization_Climber(climber);
    }
}
