...
public class intakeCharacterizationCommands {
    ...
    public static Command feedforwardCharacterization_Intake(Intake intake) {
        return characterize(
                intake,
                () -> intake.runCharacterization_Intake(0.0),
                intake::runCharacterization_Intake,
    ...
    public static Command characterizeForAll(Intake intake) {
        return feedforwardCharacterization_Intake(intake);
    }
}
