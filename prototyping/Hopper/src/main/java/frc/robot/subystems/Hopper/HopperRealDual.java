...
public class HopperRealDual implements HopperIO {
  ...
  public void updateInputs(HopperIOInputs inputs) {
    ...
    inputs.hopperTopConnected = hopperTopMotor.isConnected();
        ...
        inputs.velocityOfHopperBottomRPS = velocityOfHopperBottomRPS.getValue().in(Rotation.per(Minute));
    inputs.statorCurrentOfHopperBottomAmps = statorCurrentOfHopperBottomAmps.getValue().in(Amps);
      inputs.accelerationOfHopperBottom = accelerationOfHopperBottom.getValue()
        .in(RotationsPerSecondPerSecond);
    inputs.outputOfHopperBottomVolts = outputOfHopperBottomVolts.getValue().in(Volts);
