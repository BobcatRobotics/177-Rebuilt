...
public class ShooterReal implements ShooterIO {
  ...
  public ShooterReal() {
    //left
    shooterLeftMainMotorsPIDkP = new TunableDouble("/Shooter/MainMotor/Left/PID/kP", Constants.ShooterConstants.LeftShooterConstants.kshooterMainkP);
    shooterLeftMainMotorsPIDkI = new TunableDouble("/Shooter/MainMotor/Left/PID/kI", Constants.ShooterConstants.LeftShooterConstants.kshooterMainkI);
    shooterLeftMainMotorsPIDkD = new TunableDouble("/Shooter/MainMotor/Left/PID/kD", Constants.ShooterConstants.LeftShooterConstants.kshooterMainkD);
    shooterLeftMainMotorsPIDkV = new TunableDouble("/Shooter/MainMotor/Left/PID/kV", Constants.ShooterConstants.LeftShooterConstants.kshooterMainkV);
    ...
    shooterLeftBackspinMotorsPIDkP = new TunableDouble("/Shooter/BackSpin/Left/PID/kP", Constants.ShooterConstants.LeftShooterConstants.shooterBackspinMotorLeftMountedkP);
    shooterLeftBackspinMotorsPIDkI = new TunableDouble("/Shooter/BackSpin/Left/PID/kI", Constants.ShooterConstants.LeftShooterConstants.shooterBackspinMotorLeftMountedkI);
    shooterLeftBackspinMotorsPIDkD = new TunableDouble("/Shooter/BackSpin/Left/PID/kD", Constants.ShooterConstants.LeftShooterConstants.shooterBackspinMotorLeftMountedkD);
    shooterLeftBackspinMotorsPIDkV = new TunableDouble("/Shooter/BackSpin/Left/PID/kV", Constants.ShooterConstants.LeftShooterConstants.shooterBackspinMotorLeftMountedkV);
    shooterLeftBackspinMotorsPIDkS = new TunableDouble("/Shooter/BackSpin/Left/PID/kS", Constants.ShooterConstants.LeftShooterConstants.shooterBackspinMotorLeftMountedkS);
    shooterLeftBackspinMotorsPIDkA = new TunableDouble("/Shooter/BackSpin/Left/PID/kA", Constants.ShooterConstants.LeftShooterConstants.shooterBackspinMotorLeftMountedkA);
    ...
    //right
    shooterRightMainMotorsPIDkP = new TunableDouble("/Shooter/MainMotor/Right/PID/kP", Constants.ShooterConstants.RightShooterConstants.kshooterMainkP);
    shooterRightMainMotorsPIDkI = new TunableDouble("/Shooter/MainMotor/Right/PID/kI", Constants.ShooterConstants.RightShooterConstants.kshooterMainkI);
    shooterRightMainMotorsPIDkD = new TunableDouble("/Shooter/MainMotor/Right/PID/kD", Constants.ShooterConstants.RightShooterConstants.kshooterMainkD);
    shooterRightMainMotorsPIDkV = new TunableDouble("/Shooter/MainMotor/Right/PID/kV", Constants.ShooterConstants.RightShooterConstants.kshooterMainkV);
    shooterRightMainMotorsPIDkS = new TunableDouble("/Shooter/MainMotor/Right/PID/kS", Constants.ShooterConstants.RightShooterConstants.kshooterMainkS);
    shooterRightMainMotorsPIDkA = new TunableDouble("/Shooter/MainMotor/Right/PID/kA", Constants.ShooterConstants.RightShooterConstants.kshooterMainkA);
    shooterRightIntakeMotorsPIDkP = new TunableDouble("/Shooter/Intake/Right/PID/kP", Constants.ShooterConstants.RightShooterConstants.shooterIntakeMotorkP);
    shooterRightIntakeMotorsPIDkI = new TunableDouble("/Shooter/Intake/Right/PID/kI", Constants.ShooterConstants.RightShooterConstants.shooterIntakeMotorkI);
    shooterRightIntakeMotorsPIDkD = new TunableDouble("/Shooter/Intake/Right/PID/kD", Constants.ShooterConstants.RightShooterConstants.shooterIntakeMotorkD);
    ...
    rightFlywheelConfig = new Configurator(flyweelConfigRight, Constants.ShooterConstants.RightShooterConstants.FlywheelIDRight, false, true, 40);
    rightIntakeConfig = new Configurator(intakeConfigRight, Constants.ShooterConstants.RightShooterConstants.intakeIDRight, false, true, 40);
    rightBackspinConfig = new Configurator(backspinConfigRight, Constants.ShooterConstants.RightShooterConstants.BackspinIDRight, false, true, 40);
  ...
  public void setVelocity(ShooterState desiredState, int index) {
    setVelocity(desiredState.getFlywheelSpeed(index), desiredState.getIntakeSpeed(index), desiredState.getBackspinSpeed(index));
  }
