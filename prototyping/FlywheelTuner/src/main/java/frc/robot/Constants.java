...
//80in distance
        ...
        public final static class Left {
            ...
            // Motor Constants
            public static final double kHoodMotorkP = 0;
            public static final double kHoodMotorkI = 0.0;
            public static final double kHoodMotorkD = 0;
            public static final double kHoodMotorkS = 0;
            public static final double kHoodMotorkV = 0;
    ...
    public static final class IntakeConstants {
        ...
        public static final class RightRollerConstants {
            public static final boolean isInverted = false;
            public static final boolean isCoast = true;
            public static double kP = 0; //kP based on test was 1.995
            public static double kI = 0.00;
            public static double kD = 0.00;
